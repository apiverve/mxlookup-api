...
namespace APIVerve.API.MXLookup
{
    ...
    /// <summary>
    /// Client for the MXLookup API
    /// </summary>
    public class MXLookupAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/mxlookup";
        ...
        public MXLookupAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MXLookupAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MXLookupAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, MXLookupQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(MXLookupQueryOptions options)
        {
        ...
        public ResponseObj Execute(MXLookupQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(MXLookupQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(MXLookupQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(MXLookupQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(MXLookupQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(MXLookupQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(MXLookupQueryOptions options)
        {
