# MX Lookup API - Examples

This folder contains example code for using the MX Lookup API across different platforms.
...
const response = await fetch('https://api.apiverve.com/v1/mxlookup', {
...
response = requests.get('https://api.apiverve.com/v1/mxlookup',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/mxlookup");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/mxlookup](https://docs.apiverve.com/ref/mxlookup)
