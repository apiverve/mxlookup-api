...
// Request contains the parameters for the MX Lookup API.
//
// Parameters:
...
// ResponseData contains the data returned by the MX Lookup API.
type ResponseData struct {
	Domain string `json:"domain"`
	Mx []MxItem `json:"mx"`
}

// MxItem represents an item in the Mx array.
type MxItem struct {
