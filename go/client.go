// Package mxlookup provides a Go client for the MX Lookup API.
//
// For more information, visit: https://mxlookup.apiverve.com?utm_source=go&utm_medium=readme
package mxlookup
...
const (
	baseURL        = "https://api.apiverve.com/v1/mxlookup"
	defaultTimeout = 30 * time.Second
)

// Client is the MX Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new MX Lookup API client.
...
// Execute makes a request to the MX Lookup API with typed parameters.
//
...
//   - domain (required): string - The domain you want to get the MX records for (e.g. yahoo.com)
