...
```bash
curl -X GET "https://api.apiverve.com/v1/mxlookup?param=value" \
...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/mxlookup](https://docs.apiverve.com/ref/mxlookup)

---

## Use Cases

Common use cases for the MX Lookup API:
