...
```gradle
dependencies {
    implementation 'com.github.apiverve:mxlookup-api:1.1.14'
}
```
...
```java
import com.apiverve.mxlookup.MXLookupAPIClient;
import com.apiverve.mxlookup.APIResponse;
import com.apiverve.mxlookup.APIException;

// Initialize the client
MXLookupAPIClient client = new MXLookupAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("domain", "yahoo.com");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/mxlookup](https://docs.apiverve.com/ref/mxlookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/mxlookup](https://docs.apiverve.com/ref/mxlookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/mxlookup-api/issues)
